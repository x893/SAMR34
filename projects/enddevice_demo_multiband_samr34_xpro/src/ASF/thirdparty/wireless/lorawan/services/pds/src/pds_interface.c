/******************************************************************************
  ...
  @Summary:
    This is the PDS interface source file which has had implimentations for all public
	API's.

  @Description:
    This source file provides PDS implementation.
...
/**************************************************************************//**
\brief	This function will set the store optration to all the items stored 
